...
import Orepool from 'pages/Orepool'
...
// 新分享页面
import ShareWallet from 'pages/ShareWallet'

// 奖励明细页面
import Reward from 'pages/Reward'

// 新忘记密码页面
import NewForgetPassword from 'pages/NewForgetPassword'
import NewForgetPasswordSecound from "pages/NewForgetPasswordSecound";
import NewForgetPasswordSecoundEmail from "pages/NewForgetPasswordSecoundEmail";
...
import MiningHomepage from 'pages/MiningHomepage'
...
import moneyChanging from 'pages/moneyChanging'
...
const router =  new Router({
    ...
    routes: [
        ...
        },
        {
            ...
            name: 'NewForgetPassword',
            component: NewForgetPassword

        },
        {
            path: '/newForgetPasswordSecound',
            name: 'NewForgetPasswordSecound',
            component: NewForgetPasswordSecound
        },
        {
            path: '/newForgetPasswordSecoundEmail',
            name: 'NewForgetPasswordSecoundEmail',
            component: NewForgetPasswordSecoundEmail
        },
        ...
        },
  {
        ...
        },
        {
            ...
            name: 'Notice',
            component: Notice,
            redirect: '/notice/NoticeTabSystem',
            children: [
                {
