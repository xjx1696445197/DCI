...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            // 去资产页面
            toAsset(){
                if (localStorage.getItem("useragreemeny")==1&&localStorage.getItem("Createdsuccessfully")==1&&localStorage.getItem("userinfoall")!==""){
                    // 未登录的情况下 跳转登录页面
                    this.$replace({
                        path: '/asset'
                    })
                    ...
                    //     path: '/asset'
                    // })
                }else if(localStorage.getItem("useragreemeny")==1&&localStorage.getItem("userinfoall")!==null){
                    // 未登录的情况下 跳转登录页面
                    this.$replace({
                        path: '/walletindex'
                    })
