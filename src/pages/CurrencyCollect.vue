            ...
            <div class="content">
                <div  class="main currencyimg">
                    <img class="avatar radius-round"
                         v-if="currency=='HALE'"
                         src="../static/images/newWallet/icon_HALE2.png"    style="background: none" >
                    <img class="avatar radius-round"
                         v-if="currency=='ETH'"
                         src="../static/images/newWallet/eth.png"    style="background: none" >
                    <img class="avatar radius-round"
                            v-if="currency!=='ETH'&&currency!=='HALE'"
                          :src="icon"    style="background: none">
                    <span>
                        {{currency}}
                    </span>
                </div>
...
<script>
    ...
    import {Ethtohelle} from "../util/dip";
    ...
    export default {
        ...
        mounted(){
            ...
            if (this.CurrentlyselectedWallet==1){
                ...
                this.address=localStorage.getItem("ethassetaddress")
                this.creatQrCode(this.address)
                this.initCopyer(this.address)
            }
