...
<!--                        </div>-->
<!--                        &lt;!&ndash;<div class="googleVerification_tip">&ndash;&gt;-->
<!--                        &lt;!&ndash;<p class="googleVerification_tip_txt">通过人工客服重置你的谷歌验证需要提交工单，处理时间需要7日</p>&ndash;&gt;-->
<!--                        &lt;!&ndash;</div>&ndash;&gt;-->
        ...
        methods: {
            ...
            getDetail(refresh = false) {
                ...
                axios.get(urlUtil.getApiUrl("api_rootlist") + "/v1/two_auth/generateDCI", {
                    params: {address:this.CurrentlyselectedWallet==1?localStorage.getItem("assetaddress"):localStorage.getItem("ethassetaddress")}
                },).then((res) => {
                    that.creatQrCode("otpauth://totp/DCI?secret=" + res.data.key + "&issuer=DCI")
