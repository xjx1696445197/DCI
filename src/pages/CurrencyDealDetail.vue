            ...
            <div class="content">
                <div class="main">
                    ...
                    >
                        ...
                        <p v-if="myaddress!==detail.from_address&&detail.messages[0].type=='cosmos-sdk/MsgSend'" class="detail_txt1">{{(detail.messages[0].value.amount[0].amount/1000000).toFixed(7).slice(0, -1)||0}} {{currency}}</p>
                        <p v-if="myaddress!==detail.from_address&&detail.messages[0].type=='ethermint/MsgEthermint'" class="detail_txt1">{{(detail.messages[0].value.value/1000000).toFixed(7).slice(0, -1)||0}} {{currency}}</p>
                        <p v-if="myaddress==detail.from_address&&detail.messages[0].type=='ethermint/MsgEthermint'" class="detail_txt1">{{(detail.messages[0].value.value/1000000).toFixed(7).slice(0, -1)||0}} {{currency}}</p>
        ...
        <div class="wrapper" v-else>
            <div class="content">
                <div class="main">
                    ...
                    >
                        <div class="detail_icon mauto radius-round"></div>
                        <p v-if="myaddress!==detail.from_address&&detail.messages[0].type=='cosmos-sdk/MsgSend'" class="detail_txt1">{{(detail.messages[0].value.amount[0].amount)/1000000000000000000||0|tofixed6}} {{currency}}</p>
                        <p v-if="myaddress!==detail.from_address&&detail.messages[0].type=='ethermint/MsgEthermint'" class="detail_txt1">{{(detail.messages[0].value.value)/1000000000000000000||0|tofixed6}} {{currency}}</p>
                        <p v-if="myaddress==detail.from_address&&detail.messages[0].type=='ethermint/MsgEthermint'" class="detail_txt1">{{(detail.messages[0].value.value)/1000000000000000000||0|tofixed6}} {{currency}}</p>

                        <p class="detail_txt2" v-if="myaddress==detail.from_address&&detail.to_address!=='halle1dtujdjq4mutrkvzlmqmj95rsnfuf53acjg47dh'"><span v-if="detail.code==0">付款成功</span><span v-if="detail.code!==0">付款失败</span></p>
                        <p class="detail_txt2" v-if="myaddress!==detail.from_address"><span v-if="detail.code==0">收款成功</span><span v-if="detail.code!==0">收款失败</span></p>
                        <p class="detail_txt2" v-if="detail.to_address=='halle1dtujdjq4mutrkvzlmqmj95rsnfuf53acjg47dh'"><span v-if="detail.code==0">兑换成功</span><span v-if="detail.code!==0">兑换失败</span></p>

                    </div>
                    <div class="he">

                    </div>
                    <div class="detail_list"  v-if="detail.to_address!=='halle1dtujdjq4mutrkvzlmqmj95rsnfuf53acjg47dh'">
                        <div class="detail_item">
                            <p class="detail_item_txt1">{{$t('currencyDetail.currencyDetail_sendAddress')}}</p>
                            <p class="detail_item_txt2">{{detail.from_address || '------'}}</p>
                        </div>
                    ...
                    <div class="detail_list"  v-if="detail.to_address=='halle1dtujdjq4mutrkvzlmqmj95rsnfuf53acjg47dh'">
                        <div class="detail_item">
                            <p class="detail_item_txt1">消耗币种</p>
                            <p class="detail_item_txt2">{{(detail.messages[0].value.value)/1000000000000000000||0|tofixed6}}  IUSDT</p>
                        </div>
                        <div class="detail_item">
                            <p class="detail_item_txt1">获得币种</p>
                            <p class="detail_item_txt2">{{(detail.messages[0].value.value)/1000000000000000000||0|tofixed6}}  USDT</p>
                        </div>
                        <div class="detail_item">
                            <p class="detail_item_txt1">{{$t('currencyDetail.currencyDetail_Transaction_time')}}</p>
                            <p class="detail_item_txt2">{{(detail.timestamp.substring(0,19).replace("T"," ")|| '------')}}</p>
