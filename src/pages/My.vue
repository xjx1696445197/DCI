...
<!--        头部样式-->
        <div class="my_top">
            <div class="my_top_ITEM clearfix" @click="go" data-path="/personalCenter">
                <div class="my_top_item_icon fl">
                </div>
                <p class="my_top_ITEM_TXT fl">{{loginName}}</p>
                <div class="my_top_item_icon_right fr">
                    <img src="../static/images/newWallet/icon_go.png" alt="">
                </div>
            </div>
        </div>
...
<!--            </div>-->
            <div class="ITEM" @click="go" data-path="/notice">
                <div class="item_icon">
                    <img src="../static/images/newWallet/icon_msg.png">
                </div>
                <p class="ITEM_TXT">我的消息</p>
            </div>
            ...
            <div class="ITEM" :class="googleVerification==1?'bnone':''"  @click="go" data-path="/changeGoogleBind">
                <div class="item_icon">
...
<!--            奖励明细-->
            <div class="ITEM" @click="goReward">
                <div class="item_icon">
                    <img src="../static/images/newWallet/my_mingxi.png">
                </div>
                <p class="ITEM_TXT">奖励明细</p>
            </div>
<!--            邀请好友-->
            <div class="ITEM" @click="goShare" style="border-bottom: none">
                <div class="item_icon">
                    <img src="../static/images/newWallet/icon_share.png">
                </div>
...
/*    头部样式开始*/
    ...
    .my_top_item_icon_right{
        width: 0.3rem;
        height: 0.3rem;
        margin-top: 0.35rem;
    }
    .my_top_item_icon_right img{
