...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            vSuccessful() {
                var that = this;
                var user=JSON.parse(localStorage.getItem("userinfoall"))
                ...
                if (localStorage.getItem("Currentlyselectedcurrency") == "HALE") {
                    //halle创建
                    jsonAjax.post(urlUtil.getApiUrl("saveAddressForUser"), {
                        userId: JSON.parse(localStorage.getItem("userinfoall")).customer.customerId,
                        address: this.Mnemonic[2].accounts,
                        chain:localStorage.getItem("Currentlyselectedcurrency") == "HALE"?1:2
                    }, function (result) {
                        user.haleAddress=that.Mnemonic[2].accounts;
                        localStorage.setItem("userinfoall",JSON.stringify(user))
                    })
                    ...
                    if (localStorage.getItem("vaultlist") !== null) {
                        ...
                        vaultlist.push(
                            {
                                name: this.Mnemonic[2].name,
                                accounts: this.Mnemonic[2].accounts,
                                active: false,
                    ...
                    jsonAjax.post(urlUtil.getApiUrl("saveAddressForUser"), {
                        ...
                        user.ethAddress=that.Mnemonic[2].accounts;
                        localStorage.setItem("userinfoall",JSON.stringify(user))
                    })
                    //eth创建
                    localStorage.setItem("ethAddressinformation", JSON.stringify([this.Mnemonic[2]]))
                    localStorage.setItem("ethassetaddress", this.Mnemonic[2].accounts)
                    localStorage.setItem("ethwalltname", this.Mnemonic[2].name)
