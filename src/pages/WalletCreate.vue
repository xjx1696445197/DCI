        ...
        <div class="wrapper">
            <div class="content">
                <div class="list">
                    ...
                    <div class="item">
                        <div class="input">
                            <input class="create_input" type="password" placeholder="请再次输入密码" v-if="!hide"
                                   v-model="passwords" autocomplete="off">
                            <input class="create_input" type="text" placeholder="请再次输入密码" v-if="hide"
                                   v-model="passwords" autocomplete="off">

                            <div class="eyes_icon" :class="hide ? 'eyes_show_icon' : 'eyes_hide_icon'"
                                 @click="show()"></div>
                        </div>
