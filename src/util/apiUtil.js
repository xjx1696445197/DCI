...
// var api_rootbalanceeth = "http://192.168.3.154:8545";//测试eth地址
var api_rootbalanceeth = "https://mainnet.infura.io/v3/db382b95181f41318342f3c285fcdb3a";//正式eth地址
...
// var api_root="http://192.168.3.155:8090"//占鹏本地
var api_root="http://dciapp.hallechain.cn"//测试
// var api_root="http://halleshoptestapi.hallechain.cn"
// var api_root="http://192.168.3.139:8184"//瑞强本地
// var api_roots="http://192.168.3.139:8184"
//内置图片资源路径
...
urlUtil.getApiUrl = function (url_key) {
  ...
  switch (url_key) {
    ...
    case "api_rootbalance":
      ...
      break;
    case "api_rootbalanceeth":
      apiUrl = api_rootbalanceeth;
      break;
    case "api_rootlist":
      apiUrl = api_rootlist;
      break;
      // 热更新
    case "findNewEdition":
      apiUrl = api_root + "/app/appEdition/findNewEdition";
      break;
      // 查询下级返利算力记录
    case "pledgeRebateList":
      apiUrl = api_root + "/app/dci/pledge/pledgeRebateList";
      break;
      // 今日全部收益
    case "findMiningIncomeAndHashrate":
      apiUrl = api_root + "/app/dci/pledge/findMiningIncomeAndHashrate";
      break;
      // 收益
    case "endPledge":
      apiUrl = api_root + "/app/dci/pledge/endPledge";
      break;
      // 收益
    case "pledgeIncomeList":
      apiUrl = api_root + "/app/dci/pledge/pledgeIncomeList";
      break;
      // 抵押详情
    case "pledgeDetail":
      apiUrl = api_root + "/app/dci/pledge/pledgeDetail";
      break;
      // 抵押列表
    case "pledgeList":
      apiUrl = api_root + "/app/dci/pledge/pledgeList";
      break;
      //抵押成功
    case "startPledge":
      apiUrl = api_root + "/app/dci/pledge/startPledge";
      break;
      //消息详情
    case "getPushMsg":
      apiUrl = api_root + "/app/message/getPushMsg";
      break;

      //消息详情
    case "getMsgById":
      apiUrl = api_root + "/app/message/getMsgById";
      break;
      // 标记已读消息
    case "markReadMsg":
      apiUrl = api_root + "/app/message/markReadMsg";
      break;
      // 消息列表
    case "getMsgPageListByUserId":
      apiUrl = api_root + "/app/message/getMsgPageListByUserId";
      break;
      //代币地址
    case "findTokenManage":
      apiUrl = api_root + "/app/tokenManage/findTokenManage";
      break;
      //用户账号绑定地址
    case "userExchange":
      apiUrl = api_root + "/app/exchange/userExchange";
      break;
      //用户账号绑定地址
    case "saveAddressForUser":
      apiUrl = api_root + "/app/wallet/userWallet/saveAddressForUser";
      break;
      //意见反馈
    case "saveUserQuestion":
      apiUrl = api_root + "/questionNews/saveUserQuestion";
      break;
      // DCI意见反馈
    case "dci_saveUserQuestion":
      apiUrl = api_root + "/app/userQuestion/saveUserQuestion";
      break;
      // 获取意见反馈记录
    case "dci_findQuestionQuery":
      apiUrl = api_root + "/app/userQuestion/findQuestionQuery";
      break;
      // 获取意见反馈详情接口
    case "dci_findQuestionNewsQuery":
      apiUrl = api_root + "/app/userQuestion/findQuestionNewsQuery";
      break;
    // 标记已读
    case "dci_updateQuestionSolve":
      apiUrl = api_root + "/app/userQuestion/updateQuestionSolve";
      break;
      // 意见回复
      case "dci_saveQuestionNews":
          apiUrl = api_root + "/app/userQuestion/saveQuestionNews";
          break;
...
//各种余额
    ...
    //登录注册
      case "login":
      apiUrl = api_root + "/app/login/userLogin";
      break;
      // 获取钱包邀请码
    case 'findUserCode':
    ...
    case "user_editphone":
      ...
      break;
    //  更新密码
    case "dci_changePasswordSecond":
      apiUrl = api_root + "/app/customer/changePasswordSecond";
      break;

    //  邮箱发送验证码

    case "getEmailSecurityCode":
      apiUrl = api_root + "/app/securityCode/getEmailSecurityCode";
      break;
    //  邮箱绑定
    case "updateAccountEmail":
      apiUrl = api_root + "/app/customer/updateAccountEmail";
      break;
    // 检测账号是否绑定过手机或者邮箱
    case "changePasswordFirst":
      apiUrl = api_root + "/app/customer/changePasswordFirst";
      break;
    //修改用户基本信息
    case "user_editinfo":
