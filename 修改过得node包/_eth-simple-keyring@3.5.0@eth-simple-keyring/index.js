...
class SimpleKeyring extends EventEmitter {
  ...
  deserialize (privateKeys = []) {
    console.log(privateKeys,"privateKeysprivateKeysprivateKeysprivateKeysprivateKeysprivateKeysprivateKeysprivateKeysprivateKeysprivateKeys")
  ...
  getPublicKeyFor (address, opts = {}) {
    ...
    const wallet = this._getWalletForAccount(address, opts)
    const Public = ethUtil.toBuffer(wallet.getPublicKey())
    return Public;
  }
  ...
  exportAccountPubilc (address, opts = {}) {
    const wallet = this._getWalletForAccount(address, opts)
    return Promise.resolve(wallet.getPublicKey().toString('hex'))
  }
